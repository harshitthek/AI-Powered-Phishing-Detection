"""
Model Training Script for AI-Powered Phishing Detection.
Trains a scikit-learn pipeline combining TF-IDF N-grams and heuristic numeric features
...
def get_training_dataset() -> pd.DataFrame:
    """Returns a curated dataset containing diverse real-world phishing and legitimate email patterns."""
    data = [
        # =====================================================================
        # PHISHING SAMPLES (Label 1)
        # =====================================================================
        {
            "sender": "service-security@paypal-verification-alert.net",
            "subject": "URGENT: Your PayPal Account Has Been Suspended",
            "email_text": "Dear customer, we detected unusual login activity from an unknown IP address. Your account is temporarily locked. Click http://paypal-auth-check.net/restore immediately to verify your identity.",
            "label": 1
        },
        {
            "sender": "account-update@netflix-billing-auth.com",
            "subject": "Payment Declined: Update Your Credit Card Information",
            "email_text": "We were unable to process your subscription renewal. Please update your billing information at http://netflix-account-reactivate.co/update within 24 hours to avoid suspension.",
            "label": 1
        },
        {
            "sender": "no-reply@apple-icloud-secure.org",
            "subject": "Your Apple ID was locked due to security risks",
            "email_text": "Your Apple ID was used to sign into iCloud via a web browser in Moscow, Russia. If this was not you, confirm your password at http://icloud-session-check.biz/login right away.",
            "label": 1
        },
        {
            "sender": "rewards@amazon-giftcard-promotions.xyz",
            "subject": "Congratulations! You have been selected for a $1,000 Amazon Gift Card",
            "email_text": "You are our lucky winner! Claim your $1000 voucher immediately by visiting http://bit.ly/3xAmazonClaim and entering your postal address.",
            "label": 1
        },
        {
            "sender": "hr-payroll@corporate-direct-deposit.info",
            "subject": "ACTION REQUIRED: Mandatory Direct Deposit & Payroll Verification",
            "email_text": "Employees must re-verify their bank account details on the employee portal at http://192.168.1.105/payroll before Friday to prevent delayed paycheck processing.",
            "label": 1
        },
        {
        ...
        {
            "sender": "security-team@google-account-protection.top",
            "subject": "CRITICAL: Google Password Compromised",
            "email_text": "Someone knows your password! A suspicious app was granted access. Click http://google-security-reset.top/auth to change your password immediately.",
            "label": 1
        },
        {
            "sender": "tracking@dhl-express-package-held.com",
            "subject": "Delivery Exception: Package #US-98214 held at customs",
            "email_text": "Your package could not be delivered due to an unpaid duty fee of $2.50. Pay the fee at http://dhl-express-redelivery.com/pay to resume shipment.",
            "label": 1
        },
        {
        ...
        },
        {
            ...
            "email_text": "Your email address won 2nd prize in the Global Sweepstakes draw. Claim your funds by sending your identity verification to lottery@international-sweepstakes-winner.biz.",
            "label": 1
        },
        {
            "sender": "tax-refund@irs-government-portal.online",
            "subject": "IRS Tax Refund Notification: $1,840.50 Approved",
            "email_text": "You have an unclaimed electronic tax refund. Click http://irs-electronic-deposit.online/claim and input your SSN and routing number to receive direct deposit.",
            "label": 1
        },
        {
            "sender": "security@microsoft-365-admin-alert.cc",
            "subject": "Microsoft 365: Password Expiration Notice",
            "email_text": "Your Microsoft Office 365 password will expire in 2 hours. Keep your current password by confirming it at http://msoffice365-pass-keep.cc/auth immediately.",
            "label": 1
        },
        {
            "sender": "admin@facebook-meta-security-support.rest",
            "subject": "Your Facebook Page Will Be Deleted Within 24 Hours",
            "email_text": "Your page violated copyright terms. If you believe this is an error, appeal the decision at http://meta-copyright-appeal.rest/case-98213 immediately or face permanent termination.",
            "label": 1
        },
        {
            "sender": "billing@quickbooks-invoice-notice.link",
            "subject": "Invoice #INV-2024-9182 Overdue: Immediate Payment Required",
            "email_text": "Please find your attached invoice for $4,120.00. Click http://quickbooks-invoice-view.link/pay to avoid late penalties and legal escalation.",
            "label": 1
        },
        {
            "sender": "crypto-airdrop@binance-reward-vault.top",
            "subject": "Exclusive Binance 1.5 ETH Airdrop for Active Users",
            "email_text": "Claim your free Ethereum airdrop! Connect your Web3 wallet at http://binance-airdrop-claim.top/connect immediately before the allocation runs out.",
            "label": 1
        },

        # =====================================================================
        # LEGITIMATE / SAFE SAMPLES (Label 0)
        # =====================================================================
        {
            "sender": "alex.chen@google.com",
            "subject": "Notes from today's sprint planning & roadmap sync",
            "email_text": "Hi everyone, here are the key action items from our sync this morning. We decided to prioritize the latency improvements for Q3. Let me know if you have any feedback before tomorrow's standup.",
            "label": 0
        },
        {
...
def train_and_evaluate():
    """Trains the model on dataset and persists artifact."""
    print("=" * 65)
    ...
    # Train on full dataset for maximum production capability
    model.fit(X, y)
